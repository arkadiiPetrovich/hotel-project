...
//            System.out.println("Proceeding...");
    ...
    private void eventHandlerReviewButton() {
        QualityInterface review = new QualityInterface();
    ...
    //backButton
    public void eventHandlerBackButton() {
...
//Fix add if statement to handle wrong input
    //payDetailsButton
...
//        userHasInputBooking(); //check all fields are filled/selected correctly
    ...
    private void dayAndUnitFrame() {
        ...
        ArrayList<String> unitReviews = u.showAllUnits();
        String out = "";
        for(String units : unitReviews){
            out+= units + "\n";
        }
        view.getTextArea2().setText(out);
